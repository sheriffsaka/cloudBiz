...
const icons: { [key: string]: React.ReactNode } = {
  ...
  invoices: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M12 9v4" /><path d="M12 17h.01" /><path d="M15 2v5h5" />
    </svg>
  ),
  clients: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  'message-square': ( // New icon for chatbot
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  'download-word': ( // New icon for Word download
  ...
  eye: ( // New icon for showing password
  ...
  'eye-off': ( // New icon for hiding password
  ...
  repeat: ( // New icon for recurring invoices
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-repeat">
        ...
        <path d="M21 5H3v14h18"></path>
        <polyline points="7 13 3 17 7 21"></polyline>
    </svg>
  ),
  mail: ( // New icon for sent receipts
  ...
  menu: ( // New icon for mobile menu (hamburger)
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
